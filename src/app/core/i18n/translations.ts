...
export const translations: Record<LangCode, T> = {
  en: {
    ...
    hero: {
      ...
      h1:      'Six years. One stack. Real fintech.',
      h2:      'Angular engineering that holds up under pressure.',
      sub:     'Senior Angular specialist based in Karachi — 6 years building enterprise-grade fintech platforms for international remittance markets. Available for remote work worldwide.',
      cta1:    'See my work',
      cta2:    'Get in touch',
    },
    about: {
      ...
      p1: "I'm a Senior Frontend Engineer with 6+ years of professional experience building Angular applications for Fintech and international remittance platforms — the kind of systems where correctness, performance, and reliability aren't optional.",
      p2: 'At Techlogix, I progressed from Software Engineer to Senior, leading the end-to-end delivery of complex modules — customer onboarding, accounts payable, remittance workflows — across platforms serving UAE and Qatar markets. I architected reusable component libraries, drove a multi-version Angular migration (v6 → v15), and mentored junior developers through code reviews.',
      p3: "I care about clean architecture, type safety, and the kind of code that's still readable six months later. Now freelancing and open to remote opportunities where deep Angular expertise actually matters.",
      cta: 'See my work',
      skillsTitle: 'Skills & Expertise',
      groups: [
        { label: 'Frontend',        tags: ['Angular (v7–v15+)', 'TypeScript', 'RxJS', 'NgRx', 'Angular Material'] },
        { label: 'UI Libraries',    tags: ['Kendo UI', 'Bootstrap', 'SCSS/SASS'] },
        { label: 'Testing',         tags: ['Jasmine', 'Karma', 'Cypress'] },
        { label: 'Tools & DevOps',  tags: ['Git', 'Jenkins', 'Azure DevOps', 'Webpack'] },
      ],
    },
    ...
    contact: {
      ...
      sub:     'Senior Angular engineer open to remote contracts and full-time opportunities. Based in Karachi, available worldwide.',
